...
{id:"activities",name:"activities-sports",title:"Activities & Sports",why:"Kids' extracurriculars, schedules, gear.",
lines:[{c:"Triggers: soccer, practice, games, gear, equipment."},{h:"Oldest"},{k:"Soccer",v:"Tue/Thu 5pm, Coach Alex"},{k:"Piano",v:"Sat 10am, Ms. Lee"},{h:"Youngest"},{k:"Gymnastics",v:"Mon/Wed 4pm"},{h:"Gear"},{v:"Shinguards in garage. Piano book in car."},
{a:"Practice times, coaches, gear locations. Only loads for sports/activity questions."}]},
{id:"occasions",name:"birthdays-gifts",title:"Birthdays & Gifts",why:"Important dates, gift history.",
lines:[{h:"Family"},{k:"Oldest",v:"Jun 12"},{k:"Youngest",v:"Mar 4"},{k:"Partner",v:"Oct 22"},{h:"Gift rules"},{v:"No duplicates. Track last 3 years. Under $40 for kids' friends."},{h:"Extended"},{v:"Grandma's birthday Dec 8 — loves handwritten cards."},
...
{q:"Does my oldest have soccer tomorrow?",match:["activities"],answer:"Yes — Tuesday, 5pm with Coach Alex. Shinguards are in the garage. Don't forget the water bottle."},
{q:"What should I get my partner for their birthday?",match:["occasions","budget"],answer:"Partner's birthday is Oct 22. Last 3 years you got: a watch, cooking class, weekend trip. Budget target is under $100 for the non-experience gift."},
],
...
{id:"support",name:"customer-support",title:"Customer Support",why:"Inbound questions, refunds, escalation.",
lines:[{c:"Triggers: refund, ticket, support, angry customer."},{h:"Tone"},{v:"Direct, no corporate filler. Acknowledge the issue first."},{h:"Refund policy"},{v:"Full refund within 30 days, no questions. Past that, case-by-case."},{h:"Escalation"},{v:"Anything legal, press, or safety-related → founder immediately."},
{a:"Support context is dense. Rules that apply to refunds shouldn't be loaded when writing a blog post."}]},
{id:"investors",name:"investor-updates",title:"Investor Updates",why:"Monthly updates, asks, metrics.",
lines:[{c:"Triggers: investor, update, monthly, ask, burn."},{h:"Format"},{v:"Wins > Losses > Asks > Metrics > Ask for help."},{h:"Metrics to share"},{v:"MRR, burn, runway, headcount, pipeline."},{h:"Rule"},{v:"Never hide bad news. Investors discover it later and trust is gone."},
{a:"Investor tone is different from marketing tone. Keeps the two separate."}]},
],
sims:[
...
{id:"onetoones",name:"one-on-ones",title:"1:1s",why:"Recurring check-ins with the team.",
lines:[{c:"Triggers: 1:1, one on one, check-in, sync with (name)."},{h:"Agenda"},{v:"1. What's blocking you? 2. What should I know? 3. What should I be doing differently?"},{h:"Cadence"},{v:"Weekly for directs. Biweekly for skip-levels."},{h:"Rule"},{v:"Their agenda first. Mine last. Notes are private."},
{a:"Different rhythm and privacy than team meetings. Never mix with PRDs or stakeholder comms."}]},
{id:"planning",name:"quarterly-planning",title:"Planning",why:"OKRs, roadmap, capacity.",
lines:[{c:"Triggers: OKR, Q1/Q2/Q3/Q4, roadmap, capacity, planning."},{h:"OKR format"},{v:"Objective = qualitative. Key results = measurable. 3-5 KRs per objective max."},{h:"Team size"},{v:"8 engineers, 1 designer. ~50% capacity for planned work, ~50% for keeping the lights on."},{h:"Rule"},{v:"Never commit to more than 60% of capacity in planning. Leave room for the unknown."},
{a:"Planning context is dense (capacity math, OKR hygiene). Only loads when actually planning."}]},
],
sims:[
...
{id:"proposals",name:"proposals-sow",title:"Proposals & SOW",why:"Formal scoping and contracts.",
lines:[{c:"Triggers: proposal, SOW, scope, contract, agreement."},{h:"Structure"},{v:"Problem > Approach > Deliverables > Timeline > Price > Terms."},{h:"Pricing"},{v:"Fixed price for scoped work. Hourly for discovery. 50% deposit on contracts over $5k."},{h:"Red flags"},{v:"Vague scope, 'simple change', 'can you do it by Friday'. Push back in writing."},
{a:"SOW structure is different from a casual quote. Prevents scope creep and missed-payment disputes."}]},
{id:"time",name:"time-tracking",title:"Time Tracking",why:"Hours by client and project.",
lines:[{c:"Triggers: hours, time, logged, how long, billable."},{h:"How"},{v:"Log hours at end of each work block. Client + project + description + minutes."},{h:"Rule"},{v:"Round up to nearest 15 minutes. Non-billable admin doesn't count."},{h:"Reminder"},{v:"Bill at end of month. Acme Net 30, Bloom Net 15."},
{a:"Hours tracking is its own ritual. Invoicing pulls from here."}]},
],
sims:[
...
{id:"citations",name:"citation-manager",title:"Citations",why:"Bibliography and source tracking.",
lines:[{c:"Triggers: cite, source, bibliography, Zotero, reference."},{h:"Format"},{v:"APA 7th is the default. MLA for English, Chicago for history."},{h:"Zotero"},{v:"Every source goes into the 'Spring Semester' library first, then tagged by course."},{h:"Rule"},{v:"No direct quotes without page numbers. No paraphrasing without in-text citations. Check before submitting."},
{a:"Citation hygiene is tedious but non-negotiable. Only loads when writing or submitting."}]},
{id:"groups",name:"group-projects",title:"Group Projects",why:"Shared work with classmates.",
lines:[{c:"Triggers: group, team project, classmates, split up."},{h:"Structure"},{v:"Shared Google Doc. Each section has a named owner. Weekly sync on Sunday."},{h:"Rule"},{v:"Don't ghost. Speak up early if you're behind. Write 'I'm stuck on X' in the group chat within 24 hours of getting stuck."},{h:"Split"},{v:"Equal work ≠ equal skill. Match sections to strengths, then cross-check at the end."},
{a:"Group dynamics are different from solo work. Different rules for communication and ownership."}]},
],
sims:[
