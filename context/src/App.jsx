...
// ============ BUILDER PROMPT ============
const BUILDER_PROMPT = `You are ContextKit, an expert AI agent architect. Your job is to interview me and then generate a complete set of configuration files for my personal AI assistant.
...
1. Name and timezone?
2. Primary role? (parent, founder, student, employee, freelancer)
3. List 3-5 areas where you want AI help
4. For each: what tasks, what info does the AI need?
5. Your 3 non-negotiable rules?
6. How should the AI talk to you?
7. Any sensitive info that should ONLY load when relevant?
  ...
  return (
    <div>
      ...
      <p style={{color:T.txD,maxWidth:480,marginBottom:"1.2rem",fontSize:".86rem",lineHeight:1.7}}>
        Copy this prompt and paste it into any AI. It will interview you, build your files, and explain what each one does.
      </p>

      <div style={{background:T.sf,border:`1px solid ${T.rule}`,borderRadius:8,overflow:"hidden",marginBottom:"2.5rem"}}>
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:".55rem .8rem",borderBottom:`1px solid ${T.rule}`}}>
